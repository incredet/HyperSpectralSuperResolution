...
% Form estimate — regularise Czgx to avoid singular matrices on small tiles
eps_reg = 1e-8 * trace(Czgx) / size(Czgx,1);
if eps_reg == 0; eps_reg = 1e-10; end
Czgx = Czgx + eps_reg * eye(size(Czgx));
