...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile041.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile041.mat';
    HySure_run;
    elapsed = toc;
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile042.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile042.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile057.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile057.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile058.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile058.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile059.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile059.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile060.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile060.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile073.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile073.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile074.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile074.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile075.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile075.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile076.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile076.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile077.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile077.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile078.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile078.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile089.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile089.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile090.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile090.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile091.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile091.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile092.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile092.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile093.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile093.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile094.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile094.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile095.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile095.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile096.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile096.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile105.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile105.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile106.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile106.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile107.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile107.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile108.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile108.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile109.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile109.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile110.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile110.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile111.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile111.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile112.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile112.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile113.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile113.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile114.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile114.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile122.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile122.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile123.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile123.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile124.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile124.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile125.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile125.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile126.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile126.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile127.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile127.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
