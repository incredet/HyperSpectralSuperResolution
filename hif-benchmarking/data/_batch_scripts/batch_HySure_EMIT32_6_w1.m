...
% Dataset: EMIT32, Method: HySure, Scale: 6
% Scenes: 36
...
addpath(genpath(fullfile('/Users/incredet/Documents/Thesis/hif-benchmarking', 'methods', 'HySure')));

% --- Scene 1/36: 20250422T182135_T11SPS_20250419_tile128 ---
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile128.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile128.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile129.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile129.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile130.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile130.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile131.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile131.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile132.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile132.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile138.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile138.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile139.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile139.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile140.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile140.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile141.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile141.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile142.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile142.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile143.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile143.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile144.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile144.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile145.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile145.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile146.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile146.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile147.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile147.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile148.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile148.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile149.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile149.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile150.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile150.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile154.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile154.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile155.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile155.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile156.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile156.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile157.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile157.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile158.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile158.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile159.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile159.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile160.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile160.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile161.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile161.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile162.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile162.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile163.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile163.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile164.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile164.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile165.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile165.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile166.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile166.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile167.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile167.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile168.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile168.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile171.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile171.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile172.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile172.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
...
if ~exist('data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile173.mat', 'file')
    ...
    sri_path = 'data/SR/HySure/EMIT32/6/20250422T182135_T11SPS_20250419_tile173.mat';
    HySure_run;
    elapsed = toc;
    fid = fopen('data/SR/HySure/EMIT32/6/times.csv', 'a+');
